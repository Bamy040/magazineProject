            ...
            <section>
                <article>
                    <header>
                       ...
                       <form name='f1' action="ammo.php" method="get">
                 <table cellpadding="0" cellspacing="0" class="border" >
                        <?php include './ammo_code.php'; ?>
                    </table>
                        </br><input name="date" type="date" value=""/>
                         Количество <input name="kolv" type="text" value=""/>
                         <?php if(isset($_COOKIE['log'])):?> <input name="buya" type="submit" value="Купить"/><br>  <?php endif; ?>   
                    </form>
                        </form>
                    </header>
